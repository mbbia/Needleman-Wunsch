...
#' @export globalSequenceAlignment
#' @exportPattern "^[[:alpha:]]+"
#' @import Biostrings
#' @import Rcpp
#' @importFrom Rcpp evalCpp
#' @useDynLib NeedlemanWunsch, .registration=TRUE
#' @name NeedlemanWunsch
#' @title Perform pairwise global sequence alignment
#' @description This package contains a function that perform pairwise global 
#'  sequence alignment using the Needleman-Wunsch algorithm
#' @details In the package is contained only the function globalSequenceAlignment.
#'  It performs the pairwise global sequence alignment of the two sequences and
#'  the parameters given by the user.
#' @references Needleman-Wunsch algorithm:
